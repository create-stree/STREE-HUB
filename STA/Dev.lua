...
ThemeManager:SetDefaultTheme({
    ...
    OutlineColor    = Color3.fromRGB(0,   255, 70),
})

local Window = Library:CreateWindow({
    Title = "StreeHub",
    Footer = "StreeHub - Survive The Apocalypse - 1.0.0",
...
task.defer(function()
    ...
    btn.ImageColor3 = Color3.fromRGB(0, 255, 70)
    ...
    glowFrame.Name = "Glow"
    glowFrame.Size = UDim2.fromOffset(68, 68)
    glowFrame.Position = UDim2.fromOffset(-10, -10)
    glowFrame.BackgroundTransparency = 1
    glowFrame.ZIndex = btn.ZIndex - 1
    ...
    glowGradient.Color = ColorSequence.new(Color3.fromRGB(0, 255, 70))
    ...
    local t = 0
    local glowConn = game:GetService("RunService").Heartbeat:Connect(function(dt)
        t += dt * 2
        local alpha = math.abs(math.sin(t))
        stroke.Thickness = 2 + alpha * 2
        stroke.Color = Color3.fromRGB(0, math.floor(200 + alpha * 55), math.floor(alpha * 40))
    end)
