...
local repoMirror = "https://rawgithub.com/deividcomsono/Obsidian/main/"

local function safeLoad(path)
    local urls = { repo .. path, repoMirror .. path }
    for _, url in ipairs(urls) do
        ...
        warn("[StreeHub] Failed: " .. url)
    end
    error("[StreeHub] Could not load: " .. path)
end
