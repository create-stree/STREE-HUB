...
x2 = Tabs.Main:AddSection("Godmode")
...
x3 = Tabs.Shop:AddSection("Upgrade Jump")

local AutoUpgradeJump = false

local UpgradeJumpRemote = game:GetService("ReplicatedStorage")
    :WaitForChild("Packages")
    :WaitForChild("Net")
    :WaitForChild("RF/UpgradeJump")
