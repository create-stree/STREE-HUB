        ...
        task.spawn(function()
            while _G.AutoBuyMelee do
                ...
                if not data or not data.Pos then
                    StreeLib:Notify({
                        Title = "Bear Hub",
                        Message = "Error: Coordinates not found for this Melee in the current Sea!",
                        Duration = 3
                    })
...
v14:AddSection("Buy Craft Sea Event Items")
...
v14:AddButton({
    ...
    Callback = function()
        ...
        StreeLib:Notify({Title = "Race", Message = "Switched to Ghoul", Duration = 2})
    end
})
...
v14:AddButton({
    ...
    Callback = function()
        ...
        StreeLib:Notify({Title = "Race", Message = "Switched to Cyborg", Duration = 2})
    end
})
...
v14:AddButton({
    ...
    Callback = function()
        ...
        StreeLib:Notify({Title = "Stats", Message = "Stats Reset", Duration = 2})
    end
})
...
v14:AddButton({
    ...
    Callback = function()
        ...
        StreeLib:Notify({Title = "Race", Message = "Race Randomized", Duration = 2})
    end
})
...
v15:AddButton({
    ...
    Callback = function()
        ...
        if not RedeemRemote then
            StreeLib:Notify({Title = "Error", Message = "Redeem remote not found", Duration = 3})
            return
        end
        ...
        StreeLib:Notify({Title = "Success", Message = "All codes entered", Duration = 3})
    end
})
...
v15:AddButton({
    ...
    Callback = function()
        ...
        StreeLib:Notify({Title = "Graphics", Message = "Switched to Fast Mode", Duration = 2})
    end
})
...
v15:AddButton({
    ...
    Callback = function()
        LowCpu()
        StreeLib:Notify({Title = "Optimization", Message = "Low CPU Mode enabled", Duration = 2})
    end
})
...
v15:AddButton({
    ...
    Callback = function()
        ...
        StreeLib:Notify({Title = "Boats", Message = "Boat speed increased (client-side)", Duration = 2})
    end
})
...
v15:AddButton({
    ...
    Callback = function()
        ...
        StreeLib:Notify({Title = "Fog", Message = "Fog removed", Duration = 2})
    end
})
