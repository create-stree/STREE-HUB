...
ValentineSection:AddDropdown({
    ...
    Content = "Choose item from Valentine shop.",
    Options = {},
    Default = nil,
    Callback = function(v) _G.ValentineItem = v end
})
ValentineSection:AddPanel({
    Title = "Valentine Shop",
    ButtonText = "Refresh Shop",
    ButtonCallback = function() notify("Refreshing Valentine shop...") end,
    SubButtonText = "Buy Item",
    SubButtonCallback = function() notify("Buying item...") end
})
ValentineSection:AddToggle({
...
DungeonSection:AddPanel({
    ...
    ButtonCallback = function() notify("Teleporting to Dungeon Hub...") end
})
...
RaceSection:AddPanel({
    ...
    ButtonCallback = function() notify("Teleporting to Race Door...") end,
    SubButtonText = "Buy Ancient Quest",
    SubButtonCallback = function() notify("Buying Ancient Quest...") end
})
...
local abilities = { "Geppo", "Buso Haki", "Soru", "Observation Haki" }
for _, ab in ipairs(abilities) do
    AbilityShopSection:AddPanel({
        Title = "Buy " .. ab,
        ButtonText = "Buy",
        ButtonCallback = function() notify("Buying " .. ab .. "...") end
    })
end
local FightStyleShopSection = Tabs.Shop:AddSection("StreeHub | Fighting Style Shop")
local fightStyles = { "Black Leg", "Electro", "Fishman Karate", "Dragon Claw", "Superhuman", "Death Step", "Sharkman Karate", "Electric Claw", "Dragon Talon", "God Human", "Sanguine Art" }
for _, fs in ipairs(fightStyles) do
    FightStyleShopSection:AddPanel({
        Title = "Buy " .. fs,
        ButtonText = "Buy",
        ButtonCallback = function() notify("Buying " .. fs .. "...") end
    })
end
local SwordShopSection = Tabs.Shop:AddSection("StreeHub | Sword Shop")
local swords = { "Cutlass", "Katana", "Iron Mace", "Dual Katana", "Triple Katana", "Pipe", "Dual Headed Blade", "Bisento", "Soul Cane" }
for _, sw in ipairs(swords) do
    SwordShopSection:AddPanel({
        Title = "Buy " .. sw,
        ButtonText = "Buy",
        ButtonCallback = function() notify("Buying " .. sw .. "...") end
    })
end
local GunShopSection = Tabs.Shop:AddSection("StreeHub | Gun Shop")
local guns = { "Slingshot", "Musket", "Flintlock", "Refined Flintlock", "Cannon", "Kabucha" }
for _, gn in ipairs(guns) do
    GunShopSection:AddPanel({
        Title = "Buy " .. gn,
        ButtonText = "Buy",
        ButtonCallback = function() notify("Buying " .. gn .. "...") end
    })
end
...
StatResetSection:AddPanel({
    ...
    ButtonCallback = function() notify("Resetting stats...") end,
    SubButtonText = "Random Race",
    SubButtonCallback = function() notify("Spinning for random race...") end
})
local AccessoriesSection = Tabs.Shop:AddSection("StreeHub | Accessories")
local accs = { "Black Cape", "Swordsman Hat", "Tomoe Ring" }
for _, ac in ipairs(accs) do
    AccessoriesSection:AddPanel({
        Title = "Buy " .. ac,
        ButtonText = "Buy",
        ButtonCallback = function() notify("Buying " .. ac .. "...") end
    })
end
...
SeaStackSection:AddToggle({ Title = "Auto Farm Shark",           Content = "Auto farm Sharks in the sea.",             Default = false, Callback = function(s) _G.AutoFarmShark = s end })
SeaStackSection:AddToggle({ Title = "Auto Farm Piranha",         Content = "Auto farm Piranhas in the sea.",           Default = false, Callback = function(s) _G.AutoFarmPiranha = s end })
SeaStackSection:AddToggle({ Title = "Auto Farm Fish Crew Member",Content = "Auto farm Fish Crew Members.",             Default = false, Callback = function(s) _G.AutoFarmFishCrew = s end })
