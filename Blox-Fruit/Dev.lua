...
v15:AddButton({
    ...
    Callback = function()
        ...
        if not RedeemRemote then
            StreeLib:Notify({Title = "Error", Message = "Không tìm thấy remote Redeem", Duration = 3})
            return
        end
        ...
        StreeLib:Notify({Title = "Success", Message = "Đã thử nhập tất cả mã", Duration = 3})
    end
})
...
v15:AddButton({
    ...
    Callback = function()
        ...
        StreeLib:Notify({Title = "Graphics", Message = "Đã chuyển sang chế độ Fast Mode", Duration = 2})
    end
})
...
v15:AddButton({
    ...
    Callback = function()
        LowCpu()
        StreeLib:Notify({Title = "Optimization", Message = "Đã bật chế độ Low CPU", Duration = 2})
    end
})
...
v15:AddButton({
    ...
    Callback = function()
        ...
        StreeLib:Notify({Title = "Boats", Message = "Đã tăng tốc độ thuyền (phía client)", Duration = 2})
    end
})
...
v15:AddButton({
    ...
    Callback = function()
        ...
        StreeLib:Notify({Title = "Fog", Message = "Đã xóa sương mù", Duration = 2})
    end
})
