...
Neon.Size = UDim2.new(1, 8, 1, 8)
Neon.Position = UDim2.new(0, -4, 0, -4)
Neon.BackgroundColor3 = Color3.fromRGB(0, 255, 0)
Neon.BorderSizePixel = 0
Neon.Parent = Button
Neon.ZIndex = 0
local NeonStroke = Instance.new("UIStroke")
NeonStroke.Thickness = 2
NeonStroke.Color = Color3.fromRGB(0, 255, 0)
NeonStroke.Parent = Neon

local angle = 0
RunService.RenderStepped:Connect(function()
    angle = angle + 2
    Neon.Rotation = angle % 360
end)
