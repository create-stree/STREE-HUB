...
local function buildKeyLinksUI()
    ...
    createLinkCard("Rekonise",   "https://rkns.link/2vbo0",                         "rbxassetid://")
    createLinkCard("Linkvertise","https://link-hub.net/1365203/NqhrZrvoQhoi",       "rbxassetid://")
    createLinkCard("Lootlabs",   "https://lootdest.org/s?VooVvLbJ",                 "rbxassetid://")
