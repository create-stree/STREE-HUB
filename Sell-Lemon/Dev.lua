...
local Tabs = {
    ...
    Panel = Window:Tab({ Title = "Status Panel", Icon = "monitor" }),
...
Tabs.Main:Section({ Title = "Auto Features" })
...
Tabs.Main:Button({
    ...
    Desc = "Tarik semua lever di sewer",
    Callback = function()
...
Tabs.Main:Button({
    Title = "Vine Harvest",
    Desc = "Jalankan sewer run & harvest CashVine",
    Callback = function()
        task.spawn(function()
...
Tabs.Main:Button({
    ...
    Desc = "Teleport ke UFO / Sewer Alien",
    Callback = function()
